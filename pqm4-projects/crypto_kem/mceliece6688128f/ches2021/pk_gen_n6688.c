...
static const int nblocks_H = (SYS_N + 31) / 32;  //  209
...
#elif 1248==PK_NROWS || 1664==PK_NROWS
    #define PK_NR_2POW 2048
#else
    error: no defined PK_NR_2POW  !!!!
#endif
	// generate pk
	const int width_pkmat = nblocks_H - nblocks_I;  //  209-52=157
...
#define _PK_ROW_64BIT_ALIGNED_  0
	...
	const int width_submat = GEN_PK_T_WIDTH;  // 20
	uint32_t pkmat[PK_NROWS*width_submat];    // 1536*20*4=122880
